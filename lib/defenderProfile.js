...
function defenderProfile(pokeName, quickMove, chargeMove, options = {}) {
  const isRaid =
    typeof options.raid === 'boolean' ? options.raid : isLegendary(pokeName);
